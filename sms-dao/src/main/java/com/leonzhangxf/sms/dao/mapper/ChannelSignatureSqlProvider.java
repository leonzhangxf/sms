...
import com.leonzhangxf.sms.domain.ChannelSignatureDOCriteria.Criteria;
import com.leonzhangxf.sms.domain.ChannelSignatureDOCriteria.Criterion;
import com.leonzhangxf.sms.domain.ChannelSignatureDOCriteria;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ChannelSignatureSqlProvider {

    /**
     *
     * @mbg.generated 2018-09-05
     */
    public String countByExample(ChannelSignatureDOCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("chnl_signature");
     ...
     * @mbg.generated 2018-09-05
     */
    public String deleteByExample(ChannelSignatureDOCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("chnl_signature");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated 2018-09-05
     */
    public String insertSelective(ChannelSignatureDO record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("chnl_signature");
     ...
     * @mbg.generated 2018-09-05
     */
    public String selectByExample(ChannelSignatureDOCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ChannelSignatureDO record = (ChannelSignatureDO) parameter.get("record");
        ChannelSignatureDOCriteria example = (ChannelSignatureDOCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("chnl_signature");
     ...
     * @mbg.generated 2018-09-05
     */
    public String updateByPrimaryKeySelective(ChannelSignatureDO record) {
        SQL sql = new SQL();
        sql.UPDATE("chnl_signature");
     ...
     * @mbg.generated 2018-09-05
     */
    protected void applyWhere(SQL sql, ChannelSignatureDOCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
